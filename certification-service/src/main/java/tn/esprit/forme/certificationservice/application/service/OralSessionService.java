...
public class OralSessionService {
    ...
    public List<OralSessionResponse> findAll() {
        ...
        List<Long> evaluatorIds = sessions.stream().map(OralSession::getEvaluatorId).distinct().toList();
        Map<Long, String> evaluatorNames = userDirectoryAggregationService.resolveDisplayNames(evaluatorIds);
